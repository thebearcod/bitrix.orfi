...
<head>
    ...
    Asset::getInstance()->addString('<link href="'.SITE_TEMPLATE_PATH.'/assets/css/style.css" rel="stylesheet" type="text/css" media="screen">');
    Asset::getInstance()->addString('<link href="'.SITE_TEMPLATE_PATH.'/assets/css/mobile.css" rel="stylesheet" type="text/css" media="only screen and (max-width: 767px)">');
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-10">
                        <a class="logo" title="Официальный сайт НТЦ Промбезопасность - Главная страница" href="/">
                            <img class="logo__img" src="<?=SITE_TEMPLATE_PATH?>/assets/img/logo.png" alt="Логотип НТЦ Промбезопасность">
                            <?php
                    ...
                    <div class="col-sm-4 col-sm-offset-1 hidden-xs">
                        <div class="header__contact">
                            <div data-toggle="modal" data-target="#modalGeo" class="header__contact-address header__link">
                                ...
                                ?>
                                <span id="h_adres"><?php echo $h_adres; ?></span><span class="caret"></span>
                            </div>
                            <div id="h_email"><?php echo $h_email; ?></div>
                        </div>
                    </div>
                    <div class="col-sm-3 hidden-xs">
                        <div class="header__phone">
                            <div id="h_phone" class="header__phone-num"><?php echo $h_phone; ?></div>

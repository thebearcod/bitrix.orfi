	...
	if(check_bitrix_sessid())
	{
		...
		if(empty($arResult["ERROR_MESSAGE"]))
		{
			$arFields = Array(
                ...
                "LINK_CHEAPER" => $_POST["cheaper-link"],
				"TEXT" => $_POST["MESSAGE"],
			);
            $file = array_merge($_FILES['feedback-file'], array('del' => 'Y', 'MODULE_ID' => 'custom:main.feedback'));
        ...
        $arResult["LINK_CHEAPER"] = htmlspecialcharsbx($_POST["cheaper-link"]);
        $arResult["FILE"] = htmlspecialcharsbx($_POST["feedback-file"]);
	}
	else
